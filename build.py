...
# Description: Program which builds an outputs
# user specified machine learning model
...
NN_FNAME = "Pulsar_Stars_Neural_Network.joblib"
KN_FNAME = "Pulsar_Stars_K_Neighbours.joblib"
RF_FNAME = "Pulsar_Stars_Random_Forest.joblib"
...
def build_neural_network_model():
  ...
  max_iter_size = 5000
  solver = "lbfgs"
  activation_algorithm = "tanh"

  mlp_model = MLPRegressor(hidden_layer_sizes=hidden_layer_size, learning_rate=learning_rate, learning_rate_init=learning_rate_init, max_iter=max_iter_size, solver=solver, activation=activation_algorithm, random_state=1)
  mlp_model.fit(train_X, train_y)
  preds = np.round(abs(mlp_model.predict(test_X)))
  score = r2_score(preds, test_y)

  print("Scoring of final neural network:", score)
  print("DUMPING MODEL TO THE FILE", NN_FNAME)
  dump(mlp_model, NN_FNAME)
